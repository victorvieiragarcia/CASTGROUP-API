...
public interface CursoRepository extends JpaRepository<Curso, Integer> {
	...
	@Query("select c from Curso c where c.codigo != :codigo and (c.data_inicio between :data_inicio and :data_termino or c.data_termino between :data_inicio and :data_termino)")
